class Main {
    public static void main(String[] args) {
        ...
        DoublyLinkedList<Integer> minhaLista = new DoublyLinkedList<Integer>();
        ...
        // merge de lista
        DoublyLinkedList<Integer> listaB = new DoublyLinkedList<Integer>();
        ...
        boolean equal = false;
        equal = DoublyLinkedListManipulation.checkIfEqual(listaB, listaB);
        System.out.println("A lista B é igual a lista B: " + equal);
        equal = DoublyLinkedListManipulation.checkIfEqual(listaB, minhaLista);
